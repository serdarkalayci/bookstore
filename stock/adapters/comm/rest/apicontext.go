...
import (
	...
	middleware "github.com/serdarkalayci/bookstore/stock/adapters/comm/rest/middleware"
...
type APIContext struct {
	...
	bookStockRepo  application.BookStockRepository
	configuration map[string]string
	tp 		  trace.TracerProvider
}

// NewAPIContext returns a new APIContext handler with the given logger
func NewAPIContext(bindAddress *string, hr application.HealthRepository, br application.BookStockRepository) (*http.Server) {
