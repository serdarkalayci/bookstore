...
import (
	...
	rest "github.com/serdarkalayci/bookstore/stock/adapters/comm/rest"
	mongodb "github.com/serdarkalayci/bookstore/stock/adapters/data/redis"
	"github.com/serdarkalayci/bookstore/stock/adapters/telemetry"
...
func main() {
	...
	s := rest.NewAPIContext(bindAddress, dbContext.HealthRepository, dbContext.BookStockRepository)
